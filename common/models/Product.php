...
class Product extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
            [['main_category', 'category', 'subcategory', 'gender_type', 'currency', 'stock', 'stock_unit', 'free_shipping', 'size', 'size_unit', 'condition', 'CB', 'UB', 'status', 'featured_product', 'discount'], 'integer'],
            [['main_category', 'product_name', 'canonical_name', 'item_ean', 'price', 'currency', 'stock', 'stock_unit', 'product_detail', 'brand', 'size'], 'required'],
            [['price', 'offer_price'], 'number'],
            [['main_description', 'product_detail'], 'string'],
            [['DOC', 'DOU', 'offer_percentage', 'tax', 'type'], 'safe'],
