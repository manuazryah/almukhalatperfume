                    ...
                    <div class="close-estimate-heading-top" style="margin-bottom:30px;">
                        <div class="main-left left-address" style="padding-top: 10px;">
                            <table class="tb2">
                                ...
                                <tr>
                                    <td style="max-width: 405px;font-size: 11px;">
                                        <p style="padding-top: 15px;font-weight: 700;">PERFUME DUNIA</p>
                                        <p >OFFICE#4, 1ST FLOOR</p>
                                        <p >AL ROUHANI BUILDING, DIERA, DUBAI</p>
                                        <p >Email : customercare@perfumedunia.com</p>
                                        <p >Tel : +971-42663131</p>
                                    </td>
                                </tr>
                            </table>
                        </div>
                    ...
                    <div class="close-estimate-heading-top" style="margin-bottom:30px;">
                            ...
                            <table class="tb2">
                                ...
                                <tr>
                                    <td style="max-width: 405px;font-size: 11px;">
                                        ...
                                        <?php if (isset($bill_address->street_number) && $bill_address->street_number != '') { ?>
                                                                                        <p style="color:#000000bd;"><?= $bill_address->street_number ?></p>
                                                                                <?php } ?>
                                        <p ><?= $bill_address->location ?></p>
                                        <p ><?= $bill_address->landmark ?></p>
                                        <?php
                                                                                        $country = \common\models\CountryCode::findone($bill_address->country);
                                                                                        if (!empty($country)) {
                                                                                                ?>
                                                                                                <p style="color:#000000bd;"><?= $country->country_name ?></p>
                                                                                        <?php } ?>
                        ...
                        <div class="main-right left-address" style="padding-top: 10px;margin: 0px 30px 0px 0px;">
                            <table class="tb2">
                                ...
                                <tr>
                                    <td style="max-width: 405px;font-size: 11px;">
                                        <p style="padding-top: 15px;"> <?= $order_master->payment_status ==3? 'Cash on Delivery': 'Credit/Debit Card Payment'?></p>
                                    </td>
                                </tr>
                            </table>
                        </div>
                    ...
                    <div class="invoice-details"style="margin-top: 10px;">
                        <table style="width:100%;border-collapse: collapse;text-align: left;">
                            <tr style="border-top: 1px solid #a09c9c;">
                                ...
                                <th style="width: 15%;font-size: 12px;padding: 10px 13px;"><?= sprintf('%0.2f', $order_master->tax); ?>  (Tax)</th>
