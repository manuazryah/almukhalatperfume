        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="row table-responsive" style="margin-left: 0px;">
                        <div class="panel-body">
                                                                        ...
                                                                        if (!empty($model)) {
                                                                                foreach ($model as $value) {
                                                                                        if (isset($value['product_id']) && $value['product_id'] != '') {
                                                                                                $product_details = \common\models\Product::findOne($value['product_id']);
                                                                                                if (!empty($product_details)) {
                                                                                                        ?>
                                                                                                        <tr style="text-align:left;" class='' id="">
                                                                                                                <td>
                                                                                                                        <?= Html::a($product_details->product_name, ['/product/product/update', 'id' => $value['product_id']], ['target' => '_blank']) ?>
                                                                                                                </td>
