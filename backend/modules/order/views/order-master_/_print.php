            ...
            <div>
                <table style="width: 100%;padding-bottom: 10px;border-bottom: 2px solid #5a5959;padding-left: 10px;">
                    <tr>
                        ...
                        <th style="width:15%"><span style="float: right;padding-right: 20px;">Tax</span></th>
                ...
                <table style="width: 100%;padding-bottom: 10px;border-bottom: 2px solid #5a5959;padding-left: 10px;">
                    ...
                    foreach ($order_details as $value) {
                        ...
                        $producttax = $value->amount - ($value->tax / $value->quantity);
//                        $producttax = common\models\Cart::productTax($product,$value->quantity);
//                        $rate = ($value->amount - $producttax) * $value->quantity;
                        ?>
                        <tr>
                            ...
                            <td style="width:15%"><span style="float: right;padding-right: 20px;"><?= sprintf('%0.2f', $producttax); ?></span></td>
                            <td style="width:15%"><span style="float: right;padding-right: 20px;"><?= sprintf('%0.2f', $value->tax); ?></span></td>
...
//                        $total_tax += $producttax;
                ...
                <table style="width: 100%;padding-bottom: 10px;border-bottom: 2px solid #5a5959;">
                    <tr>
                        ...
                        <td style="width:15%"><span style="float: right;font-weight: 600;padding-right: 20px;"><?= sprintf('%0.2f', $order_master->tax); ?></span></td>
                        
                        <td style="width:20%"><span style="float: right;font-weight: 600;padding-right: 20px;"><?= sprintf('%0.2f', $order_master->total_amount); ?></span></td>
                    </tr>
                    <?php
                    ...
                    <tr>
                        ...
                        <td style="width:15%"></td>
                        <td style="width:15%"></td>
                        <td style="width:20%"><span style="float: right;font-weight: 600;padding-right: 20px;"><?= sprintf('%0.2f', $order_master->shipping_charge); ?></span></td>
                    </tr>
                    <?php if ($order_master->gift_wrap == "1") { ?>
                    <tr>
                        <td style="width:50%"><span style="float: right;font-weight: 600;padding-right: 20px;">Gift Wrap Charges</span></td>
                        <td style="width:15%"></td>
                        <td style="width:15%"></td>
                        <td style="width:15%"></td>
                        <td style="width:20%"><span style="float: right;font-weight: 600;padding-right: 20px;"><?= sprintf('%0.2f', $order_master->gift_wrap_value); ?></span></td>
                    </tr>
                    <?php }?>
                </table>
                <?php // $grand_total = $amount_total + $delivary_charge + $total_tax - $promotion_disvount; ?>
                <table style="width: 100%;padding-bottom: 10px;">
                    <tr>
                        <td style="width:65%"><span style="float: right;font-weight: 600;padding-right: 20px;"> Grand Total</span></td>
                        <td style="width:15%"></td>
                        <td style="width:20%"><span style="float: right;font-weight: 600;padding-right: 20px;"><?= sprintf('%0.2f', $order_master->net_amount); ?></span></td>
                    </tr>
                </table>
            </div>
            <footer>
