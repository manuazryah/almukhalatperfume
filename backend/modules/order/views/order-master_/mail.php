...
//                                                            $order_product->rate = $order_product->rate - $order_product;
                                                            ...
                                                            <tr style="<?= $count == $p ? 'border-bottom: 1px solid #a09c9c;' : '' ?>">
                                                                <td style="padding-bottom: 1em;font-size: 12px;">
                                                                    <img src="<?= $image ?>" style="float:left">
                                                                        <span style="vertical-align: middle;margin-top: 25px;display: inline-block;"><?= $product_detail->product_name; ?></span>
