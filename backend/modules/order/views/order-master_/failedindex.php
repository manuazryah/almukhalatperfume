                ...
                <div class="panel-body">
                    ...
                    <ul class="nav nav-tabs">
                        <li class="<?= $order_status == '' ? 'active' : '' ?>">
                            <?= Html::a('<span class="visible-xs"><i class="fa-home"></i></span><i class="fa fa-th-list" aria-hidden="true"></i><span class="hidden-xs">All Orders</span>', ['failed-order'], ['class' => '']) ?>
                        </li>
                        <li class="<?= $order_status == '0' ? 'active' : '' ?>">
                            <?= Html::a('<span class="visible-xs"><i class="fa-home"></i></span><i class="fa fa-th-list" aria-hidden="true"></i><span class="hidden-xs">Pending</span>', ['failed-order', 'order_status' => 0], ['class' => '']) ?>
                        </li>
                        <li class="<?= $order_status == '4' ? 'active' : '' ?>">
                            <?= Html::a('<span class="visible-xs"><i class="fa-home"></i></span><i class="fa fa-th-list" aria-hidden="true"></i><span class="hidden-xs">Delivered</span>', ['failed-order', 'order_status' => 4], ['class' => '']) ?>
                        </li>
                        <li class="<?= $order_status == '5' ? 'active' : '' ?>">
                            <?= Html::a('<span class="visible-xs"><i class="fa-home"></i></span><i class="fa fa-th-list" aria-hidden="true"></i><span class="hidden-xs">Cancelled</span>', ['failed-order', 'order_status' => 5], ['class' => '']) ?>
                        </li>
                                ...
                                [
                                    ...
                                    'value' => function ($data) {
                                        if (isset($data->order_id)) {
                                            return \yii\helpers\Html::a($data->order_id, ['/order/order-master/order-view', 'id' => $data->order_id] 
//                                                    ,['target' => '_blank']
                                                    );
                                        } else {
                                            return '';
