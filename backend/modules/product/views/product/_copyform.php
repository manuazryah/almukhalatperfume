...
<div class="product-form form-inline">
    ...
    <div class="row">
        <div class="col-md-12">
            <?= Html::submitButton($model->isNewRecord ? '<i class="fa fa-plus" style="margin-right: 9px;"></i><span style="padding-right: 9px;">Create</span>' : '<i class="glyphicon glyphicon-pencil" style="margin-right: 9px;"></i><span style="padding-right: 9px;">Update</span>', ['class' => 'btn btn-success  btn-icon ', 'style' => 'float: right;']) ?>
        ...
        <div class="tab-pane active" id="general">
            <div class="row">
                ...
                <div class='col-md-4 col-sm-6 col-xs-12'>
                    ...
                    ?>
                    <?= $form->field($model, 'type')->dropDownList(ArrayHelper::map(common\models\ProductType::find()->where(['status' => '1'])->all(), 'id', 'product_type'), ['class' => 'form-control', 'multiple' => 'multiple']) ?>
                </div>
                <div class='col-md-4 col-sm-6 col-xs-12 '>
