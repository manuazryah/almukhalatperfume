...
<div id="wpo-mainbody product" class="container wpo-mainbody">
    ...
    <nav class="woocommerce-breadcrumb"><a class="home" href="">Home</a>&nbsp;/&nbsp;<a href="">Fragrance</a></nav>
    <section class="wpo-content-product content-product">
        ...
        <div class="row">
            ...
            <?php
//            $brand_list = common\models\Brand::find()->where(['status' => 1, 'brand' => $brand])->all();
            $brand_list = common\models\Brand::find()->where(['status' => 1])->groupBy(['brand'])->all();
            ?>
            <?= SidemenuWidget::widget(['brand_list' => $brand_list]) ?>
